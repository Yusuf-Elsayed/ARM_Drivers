...
//#define LED2_PIN 1
//u8 BIT_VAL = 1;
//// ... Define the other LED pins similarly
//
//void Led1_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED1_PIN);
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, LED1_PIN, GPIO_TGLPin);
//}
//
//
//void Led2_Task(void) {
...
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, LED2_PIN, GPIO_TGLPin);
//
//}
//void Led3_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED2_PIN);
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, 2, GPIO_TGLPin);
//
//}
//void Led4_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED2_PIN);
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, 3, GPIO_TGLPin);
//
//}
//void Led5_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED2_PIN);
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, 4, GPIO_TGLPin);
//
//}
//void Led6_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED2_PIN);
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, 5, GPIO_TGLPin);
//
//}
//void Led7_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED2_PIN);
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, 6, GPIO_TGLPin);
//
//}
//void Led8_Task(void) {
//    // Replace with actual GPIO control function
//    // Example: GPIO_TogglePin(LED2_PIN);
//
//	GPIO_voidchangePinoutvalue(GPIO_u8PortA, 7, GPIO_TGLPin);
//
//}
//// Define similar tasks for the other LEDs (Led3_Task, Led4_Task, ...)
//
//int main(void) {
//		RCC_voidInit();
...
//		}
//	// Initialize the OS and system tasks
...
//		RTOS_u8CreateTask(Led3_Task, 200, 2, 0);  // LED2 task with 150 ms periodicity
//		RTOS_u8CreateTask(Led4_Task, 240, 3, 0);  // LED2 task with 150 ms periodicity
//		RTOS_u8CreateTask(Led5_Task, 250, 4, 0);  // LED2 task with 150 ms periodicity
//		RTOS_u8CreateTask(Led6_Task, 320, 5, 0);  // LED2 task with 150 ms periodicity
//		RTOS_u8CreateTask(Led7_Task, 460, 6, 0);  // LED2 task with 150 ms periodicity
//		RTOS_u8CreateTask(Led8_Task, 540, 7, 0);  // LED2 task with 150 ms periodicity
//
//
//		// Create similar tasks for the other LEDs
//
//		Start_OS();
//
//
